...
namespace FreelancePlatform.Migrations
{
    ...
    [Migration("20260430065833_AddUserMetadata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelancePlatform.Models.BlacklistEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.GroupChatMessageRead", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GroupChatMessageReads");
                });
            ...
            modelBuilder.Entity("FreelancePlatform.Models.PaymentShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("AutoShare")
                        .HasColumnType("numeric");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("FinalShare")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.ProjectActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.ProjectMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.ProjectTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.ReputationEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.TaskTemplateItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.UserBalance", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.UserMetadata", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.UserReputation", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FreelancePlatform.Models.WorkItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CategoryProject", b =>
                {
                    ...
                    b.HasOne("FreelancePlatform.Models.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CategoryService", b =>
                {
                    ...
                    b.HasOne("FreelancePlatform.Models.Service", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FreelancePlatform.Models.GroupChatMention", b =>
                {
                    b.HasOne("FreelancePlatform.Models.GroupChatMessage", "GroupChatMessage")
                        .WithMany("Mentions")
            ...
            modelBuilder.Entity("FreelancePlatform.Models.GroupChatMessageRead", b =>
                {
                    b.HasOne("FreelancePlatform.Models.GroupChatMessage", "Message")
                        .WithMany("ReadBy")
            ...
            modelBuilder.Entity("FreelancePlatform.Models.Order", b =>
                {
                    ...
                    b.HasOne("FreelancePlatform.Models.TaskTemplate", "TaslTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("FreelancePlatform.Models.Project", b =>
                {
                    ...
                    b.HasOne("FreelancePlatform.Models.TaskTemplate", "TaskTemplate")
                        .WithMany()
                        .HasForeignKey("TaskTemplateId");
